...
\dirtree{%
.1 XYZ Option:Boolean$\hspace{35pt}$\begin{minipage}[t]{5cm}
The top level option, off by default\\
\end{minipage}. 
.2 XYZ Sub-Option:Boolean$\hspace{35pt}$\begin{minipage}[t]{5cm}
    If Option is false, this should be off, unsettable, and never accessed\\
\end{minipage}. 
.3 XYZ Sub-Sub-Option:Boolean$\hspace{35pt}$\begin{minipage}[t]{5cm}
...
\dirtree{%
.1 XYZ Option:Radio{o1,o2,o3}$\hspace{35pt}$\begin{minipage}[t]{5cm}
...
\end{minipage}. 
.3 XYZ boolSubOpt:Boolean $\hspace{35pt}$\begin{minipage}[t]{5cm}
...
\end{minipage}. 
.3 XYZ inSubOpt:Input $\hspace{35pt}$\begin{minipage}[t]{5cm}
